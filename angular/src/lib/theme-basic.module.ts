...
import { COstumnavbar } from 'src/app/navbarcomponent/navbar-component';
...
export const LAYOUTS = [ApplicationLayoutComponent,COstumnavbar, AccountLayoutComponent, EmptyLayoutComponent];
