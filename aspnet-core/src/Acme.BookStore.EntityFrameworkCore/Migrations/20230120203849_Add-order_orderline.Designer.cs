...
namespace Acme.BookStore.Migrations
{
    ...
    [Migration("20230120203849_Add-order_orderline")]
    partial class Addorder_orderline
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Acme.BookStore.Currency_code.CurrencyCodes", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("AppCurrencyCodes", (string)null);
                });

            modelBuilder.Entity("Acme.BookStore.Email.Emailtemplate", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Acme.BookStore.OrderModul.OrderLine", b =>
                {
                    ...
                    b.ToTable("AppOrderLine", (string)null);
                });

            modelBuilder.Entity("Acme.BookStore.OrderModul.Orders", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Acme.BookStore.ProductModule.Product", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("BOOKSTore.Employee.EmployeeDetails", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Volo.Abp.Identity.IdentityUser", b =>
                {
                    ...
                    b.HasCheckConstraint("Check_Gender_Ck", "Gender='M'  or Gender = 'F' or Gender= 'O'");
                });
            ...
            modelBuilder.Entity("Acme.BookStore.OrderModul.OrderLine", b =>
                {
                    b.HasOne("Acme.BookStore.OrderModul.Orders", "Orders")
                        .WithMany("orderLines")
                        .HasForeignKey("OrderId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Acme.BookStore.ProductModule.Product", "Product")
                        .WithMany()
